...
const globalstyle = StyleSheet.create({
  ...
  headerTitleStyle: { fontFamily: fonts.primarySemiBold, fontSize: isIPad ? 22 : 18, textTransform: 'capitalize', color: isDarkMode ? colors.white : colors.black },
  ...
  authheading: { textTransform: 'uppercase', fontFamily: fonts.primarySemiBold, fontSize: 32, marginBottom: 0, textAlign: 'center', color: colors.black, marginTop: 60 },
  authdescription: { fontFamily: fonts.primary, marginBottom: 40, textAlign: 'center', color: colors.grey },
  ...
  actionauthtext: { color: isDarkMode ? colors.white : colors.black, fontFamily: fonts.primarySemiBold, fontSize: isIPad ? 18 : fontSize },
  authlefticon: { color: isDarkMode ? colors.white : colors.blue },
  // showhideicontouch: { padding: 10, zIndex: 1, position: 'absolute', right: 10, },
  // showhideicon: { color: '#999' },
